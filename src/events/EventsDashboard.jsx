  ...
  if (view === 'detail' && selectedEvent) {
    ...
    return (
      <div className="min-h-screen bg-sand-light">
        <button
          onClick={handlePrint}
          className="fixed top-4 right-4 z-40 inline-flex items-center gap-2 rounded-full bg-white border border-sand-dark px-4 py-2 text-sm font-semibold text-ink-light shadow-md transition hover:border-gold hover:text-gold cursor-pointer"
        >
          <Printer size={14} />
          Print Forms
        </button>
